...
import (
	...
	"github.com/jfgrea27/hazy-rabbit-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(hazyv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0ee6e90f.hazy.com",
	...
	if err = (&controller.HazyZoneReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "HazyZone")
		os.Exit(1)
	}
